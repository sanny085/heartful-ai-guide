          ...
          messages: [
            {
              role: "system",
              content:
                `You are an experienced medical doctor analyzing health reports. Provide a comprehensive analysis in ${language} with the following structure:
...
Be empathetic, clear, and actionable in your analysis.`,
            },
            {
              ...
              content: isImage
                ? [
                    {
                      type: "text",
                      text:
                        `Please analyze this medical report and provide detailed insights with do's, don'ts, and preventive measures in ${language}.` +
                        (additionalContext
                ...
                : `Please analyze this medical document and provide detailed insights with do's, don'ts, and preventive measures in ${language}${
                    additionalContext
                      ? `\n\nAdditional context: ${additionalContext}`
                      : ""
