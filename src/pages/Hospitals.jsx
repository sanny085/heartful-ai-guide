...
import { Building2, Sparkles, Clock, CheckCircle2, ArrowLeft, Stethoscope } from "lucide-react";
        ...
        <div className="relative z-10 container mx-auto px-4 py-12 md:py-16">
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              Access comprehensive healthcare services and specialized medical care from our trusted network of partner hospitals.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-3xl mx-auto">
          <Card className="p-8 md:p-12 text-center border-2 border-accent/20 bg-gradient-to-br from-card via-card to-card/95 shadow-2xl">
            ...
            <div className="relative mb-8 flex justify-center">
              <div className="relative">
                ...
                <div className="absolute -bottom-2 -left-2">
                  <Stethoscope className="w-6 h-6 text-primary animate-bounce" />
                </div>
              </div>
            </div>
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed max-w-2xl mx-auto">
              Our hospitals feature is currently under development. We're working hard to bring you access to premium hospital services, specialized care, and comprehensive medical facilities from trusted healthcare institutions.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              <div className="p-4 rounded-lg bg-accent/5 border border-accent/10">
                ...
                <p className="text-sm font-medium text-foreground">Specialized Care</p>
                <p className="text-xs text-muted-foreground mt-1">Expert medical services</p>
              </div>
              <div className="p-4 rounded-lg bg-accent/5 border border-accent/10">
                <CheckCircle2 className="w-6 h-6 text-success mx-auto mb-2" />
                <p className="text-sm font-medium text-foreground">Advanced Facilities</p>
                <p className="text-xs text-muted-foreground mt-1">State-of-the-art equipment</p>
              </div>
              <div className="p-4 rounded-lg bg-accent/5 border border-accent/10">
                <CheckCircle2 className="w-6 h-6 text-success mx-auto mb-2" />
                <p className="text-sm font-medium text-foreground">24/7 Services</p>
                <p className="text-xs text-muted-foreground mt-1">Round-the-clock care</p>
              </div>
            </div>
